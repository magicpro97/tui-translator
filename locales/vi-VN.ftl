...
help-device-picker = Trong bộ chọn thiết bị: ↑/↓ hoặc Tab/Shift+Tab để đổi, Enter xác nhận, Esc huỷ
help-reload = Tải lại config từ đĩa
help-help = Hiện / ẩn trợ giúp
help-esc = Đóng lớp phủ này
help-tab = Đổi tiêu điểm khung A/B (chế độ hai khe)
help-gain = Âm mic  -1/+1 dB    { "{" } / { "}" } Âm TTS  -1/+1 dB
help-reset = Đặt lại mic và TTS về 0 dB (CTRL-01)
help-quit = Thoát — hiển thị tóm tắt phiên

help-bar-scrollable = Trợ giúp [{ $position }] — ↑↓ cuộn · Esc đóng
help-bar-static = Trợ giúp — bấm ? hoặc Esc để đóng
